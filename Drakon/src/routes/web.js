...
const initWebRouter = (app) => {
    ...
    router.get('/api/getPhone/:invite', adminController.getPhoneByInvite); //get phone of referral member
    router.get('/api/getUserCount/:code', adminController.getUserByCode); //get user count of code member
    router.get('/api/referredUsers/:code', adminController.getReferredUsers);
