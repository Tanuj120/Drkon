...
const cronJobGame1p = (io) => {
    cron.schedule('*/1 * * * *', async() => {
        ...
        const [winGo1] = await connection.execute('SELECT * FROM `wingo` WHERE `game` = "wingo" ORDER BY CAST(`period` AS UNSIGNED) DESC, `id` DESC LIMIT 2 ', []);
        ...
        const [k5D] = await connection.execute('SELECT * FROM 5d WHERE `game` = 1 ORDER BY CAST(`period` AS UNSIGNED) DESC, `id` DESC LIMIT 2 ', []);
        ...
        const [k3] = await connection.execute('SELECT * FROM k3 WHERE `game` = 1 ORDER BY CAST(`period` AS UNSIGNED) DESC, `id` DESC LIMIT 2 ', []);
    ...
    cron.schedule('*/3 * * * *', async() => {
        ...
        const [winGo1] = await connection.execute('SELECT * FROM `wingo` WHERE `game` = "wingo3" ORDER BY CAST(`period` AS UNSIGNED) DESC, `id` DESC LIMIT 2 ', []);
        const data = winGo1; // Cầu mới chưa có kết quả
        io.emit('data-server', { data: data });

        await k5Controller.add5D(3);
        await k5Controller.handling5D(3);
        const [k5D] = await connection.execute('SELECT * FROM 5d WHERE `game` = 3 ORDER BY CAST(`period` AS UNSIGNED) DESC, `id` DESC LIMIT 2 ', []);
        const data2 = k5D; // Cầu mới chưa có kết quả
        io.emit('data-server-5d', { data: data2, 'game': '3' });

        await k3Controller.addK3(3);
        await k3Controller.handlingK3(3);
        const [k3] = await connection.execute('SELECT * FROM k3 WHERE `game` = 3 ORDER BY CAST(`period` AS UNSIGNED) DESC, `id` DESC LIMIT 2 ', []);
        const data3 = k3; // Cầu mới chưa có kết quả
    ...
    cron.schedule('*/5 * * * *', async() => {
        ...
        const [winGo1] = await connection.execute('SELECT * FROM `wingo` WHERE `game` = "wingo5" ORDER BY CAST(`period` AS UNSIGNED) DESC, `id` DESC LIMIT 2 ', []);
        const data = winGo1; // Cầu mới chưa có kết quả
        io.emit('data-server', { data: data });

        await k5Controller.add5D(5);
        await k5Controller.handling5D(5);
        const [k5D] = await connection.execute('SELECT * FROM 5d WHERE `game` = 5 ORDER BY CAST(`period` AS UNSIGNED) DESC, `id` DESC LIMIT 2 ', []);
        const data2 = k5D; // Cầu mới chưa có kết quả
        io.emit('data-server-5d', { data: data2, 'game': '5' });

        await k3Controller.addK3(5);
        await k3Controller.handlingK3(5);
        const [k3] = await connection.execute('SELECT * FROM k3 WHERE `game` = 5 ORDER BY CAST(`period` AS UNSIGNED) DESC, `id` DESC LIMIT 2 ', []);
        const data3 = k3; // Cầu mới chưa có kết quả
    ...
    cron.schedule('*/10 * * * *', async() => {
        ...
        const [winGo1] = await connection.execute('SELECT * FROM `wingo` WHERE `game` = "wingo10" ORDER BY CAST(`period` AS UNSIGNED) DESC, `id` DESC LIMIT 2 ', []);
        const data = winGo1; // Cầu mới chưa có kết quả
        io.emit('data-server', { data: data });
        ...
        const [k5D] = await connection.execute('SELECT * FROM 5d WHERE `game` = 10 ORDER BY CAST(`period` AS UNSIGNED) DESC, `id` DESC LIMIT 2 ', []);
        const data2 = k5D; // Cầu mới chưa có kết quả
        io.emit('data-server-5d', { data: data2, 'game': '10' });

        await k3Controller.addK3(10);
        await k3Controller.handlingK3(10);
        const [k3] = await connection.execute('SELECT * FROM k3 WHERE `game` = 10 ORDER BY CAST(`period` AS UNSIGNED) DESC, `id` DESC LIMIT 2 ', []);
        const data3 = k3; // Cầu mới chưa có kết quả
